...
def exibir_resultado(data):
    ...
    st.markdown(f"**🏙️ Cidade:** {data['localidade']}")
    st.markdown(f"**🗺️ UF:** {data['uf']}")
...
with coll:
    cep_p = st.text_input("✏️ Digite o CEP:", "", max_chars=8)
...
st.info("ℹ️ API de consulta de CEP utilizada: ViaCEP")
